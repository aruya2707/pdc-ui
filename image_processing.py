...
# tidak ada perubahan untuk zoom karna ada batasan
def zoomin():
    img = Image.open("static/img/img_now.jpg")
    img = img.convert("RGB")
    img_arr = np.asarray(img)
...
# Membaca dan menghitung citra
def count_selected_shapes(image_path):
...
image_path = 'hitung2.jpg'
shape_count, result_image = count_selected_shapes(image_path)
print("Selected shape Count:", shape_count)
